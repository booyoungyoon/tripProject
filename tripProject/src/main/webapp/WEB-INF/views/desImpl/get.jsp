...
<ul class="nav nav-tabs nav-fill">
  ...
  <li class="nav-item">
   <h3> <a class="nav-link disabled" href="#content_inf">정보보기</a></h3>
  </li>
  <li class="nav-item">
...
<br><br>
	...
	<br><br>
	<hr>	
	<h3><a id="content_inf" name="content_inf"></a>정보보기</h3>
	<hr>	
	<p>전화번호 : ${data.tel}</p>
...
<div class="d-grid gap-2 d-md-flex justify-content-md-end"> 
  <button type="button" class="btn btn-outline-primary btn-lg"><a href="/desImpl/list.do">목록으로</a></button> 
 <div>
	<script type="text/javascript" 
